<template>
    <div class="fixed inset-0 z-50 flex justify-center items-center bg-black/80">
      ...
      <div class="py-3 border-b">
        <h2 class="text-md font-bold text-gray-800">Registered Users - {{ eventId.name }}</h2>
        <p class="text-sm text-gray-400">Manage attendees and track check-in status for your event</p>
      </div>
      ...
      <div class="overflow-y-auto max-h-[65vh]">
        <table class="min-w-full text-left border-collapse">
          ...
          <tbody v-if="registrations.length" class="divide-y-2 divide-gray-200 text-sm">
            <tr
            ...
            >
              ...
              <td class="p-4">
                <span
                  :class="reg.checked_in ? 'text-green-600 font-medium' : 'text-red-500 font-medium'"
                >
